...
# Download AdultCensusIncome.csv from Azure Storage Blob. This file has 32,561 rows.
...
if not os.path.isfile(dataFile):
    ...
    block_blob_service.get_blob_to_path(
        "spark4pdms", 
        "example/data/AdultCensusIncome.csv", 
        os.path.join(local_path , dataFile)
    )
    #r = requests.get("https://d3ykhwqrp6tfe.blob.core.windows.net/spark4pdms/example/data/" + dataFile)
